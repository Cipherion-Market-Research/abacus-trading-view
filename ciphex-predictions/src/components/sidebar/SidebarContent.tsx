    ...
    <>
      ...
      <div className="flex-1 overflow-hidden p-3 flex flex-col min-h-0">
        {loading ? (
          ...
          <div className="flex flex-col h-full min-h-0 gap-2 md:gap-3">
            <CycleProgress
      ...
      {showFooter && (
        <div className="px-3 md:px-4 py-2 md:py-3 border-t border-[#30363d] text-[11px] text-[#8b949e] flex justify-between">
